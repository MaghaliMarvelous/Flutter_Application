...
class FootballPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return Obx(() => footballController.isMobile.value
              ? _buildMobileView()
              : _buildWidescreenView());
        },
      ),
    );
  }
  ...
  Widget _buildWidescreenView() {
    return Container(
      margin: const EdgeInsets.all(12),
      child: Obx(() => GridView.builder(
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: 2, // 2 columns for widescreen
              childAspectRatio: 3,
              crossAxisSpacing: 12,
              mainAxisSpacing: 12,
            ),
  ...
  Widget _buildPlayerCard(player, int index) {
